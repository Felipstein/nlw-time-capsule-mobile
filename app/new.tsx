    ...
    >
      ...
      <View className="mt-6 space-y-6">
        ...
        <TouchableOpacity
          ...
          className="max-h-96 min-h-[128px] items-center justify-center rounded-lg border border-dashed border-gray-500 bg-black/20"
        >
          {preview ? (
            <Image
              source={{ uri: preview }}
            ...
            <View className="flex-row items-center gap-2">
              <Icon name="image" color="#575757"></Icon>
